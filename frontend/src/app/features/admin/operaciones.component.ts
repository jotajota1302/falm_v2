...
export class AdminOperacionesComponent implements OnInit {
  ...
  ops: Op[] = [
    ...
    { id: 'heredar', titulo: 'Heredar alineaciones', rpc: 'heredar_alineaciones', porJornada: true,
      desc: 'A quien no ha subido once le copia el de la jornada anterior, tapando los huecos de los bloqueados. Si no hay jornada anterior, le pone el mejor once por precio.' },
    { id: 'vivo', titulo: 'Puntuar lo ya jugado', rpc: 'puntuar_en_vivo', porJornada: false,
      desc: 'Mete los puntos de los partidos que ya han acabado, sin esperar a que termine la jornada. El cron lo hace solo cada 10 minutos; esto es para no esperar.' },
