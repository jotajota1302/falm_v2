...
@Component({
  ...
  styles: [`
    ...
    .th { margin: 18px 0 10px; font-size: var(--t-md); }
    ...
    .row { display: grid; grid-template-columns: 30px 1fr 32px 28px 28px 28px 28px 28px 44px; align-items: center;
      padding: 9px 12px; border-bottom: 1px solid var(--line); font-size: var(--t-sm); text-align: center; }
    .row:last-child { border-bottom: none; }
    .row.head { font-size: var(--t-xs); text-transform: uppercase; color: var(--text2); font-weight: 700; }
    ...
    .jl { font-size: var(--t-xs); text-transform: uppercase; letter-spacing: .05em; color: var(--por); font-weight: 700; }
    ...
    .t { font-size: var(--t-sm); color: var(--text2); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .t.izq { text-align: right; } .t.der { text-align: left; }
    .pt.gl .izq, .pt.gv .der { color: var(--text); font-weight: 700; }
    .mk { font-weight: 700; font-size: var(--t-md); }

    @media (max-width: 620px) {
      .row { grid-template-columns: 26px 1fr 30px 44px; font-size: var(--t-sm); padding: 9px 10px; }
