...
| `once_resuelto.sql` | Quién suma y quién se queda fuera: relevos, `puntos_once` y el marcador en vivo |
...
| `once_resuelto_test.sql` | 6 casos de relevos: sin bajas, titular caído, portería, suplente sin hueco y pendiente |
